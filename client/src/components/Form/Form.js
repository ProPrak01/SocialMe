  ...
  return (
    <Paper className={classes.paper} elevation={6}>
      <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
        ...
        <Button className={classes.buttonSubmit}  style={{backgroundColor:'#F38181'}} variant="contained"  size="large" type="submit" fullWidth>Submit</Button>
        <Button  style={{backgroundColor:'#F38181'}} variant="contained"  size="small" onClick={clear} fullWidth>Clear</Button>
      </form>
    </Paper>
  );
};
